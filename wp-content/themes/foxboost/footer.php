...
<div class="popup hidden" id="popup-deactivate">
    <h2 class="title popup__title">Учетная запись деактивирована</h2>
    <p class="popup__text">
        Вы успешно деактивировали свою учетную запись. Теперь вы не будете получать уведомления о новых товарах, поступивших в
        продажу, а также не будете получать информационную рассылку.
        <br>
        <br>
...
<div class="popup hidden" id="popup-unsubscribe">
    ...
    <p class="popup__text">
        Вы успешно отписались от информационной рассылки. Теперь вы не будете получать уведомления о поступлении товара в продажу.
        <br>
        <br>
        Чтобы вновь получать уведомления создайте заявку на заинтересовавший вас товар.
    </p>
